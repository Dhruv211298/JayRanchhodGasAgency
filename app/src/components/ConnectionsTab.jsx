    ...
    <div>
      ...
      {tt && (
        <div className="stat-row">
          ...
          <div className="stat-card" style={{ "--kpi-color": T.danger }}><div className="stat-val" style={{ color: T.danger }}>−{tt.cylindersOut}</div><div className="stat-lbl">Filled Issued</div><div className="stat-delta" style={{ color: T.success }}>+{tt.cylindersIn} empty back{tt.cylindersMissing > 0 ? ` · ${tt.cylindersMissing} missing` : ""}</div></div>
